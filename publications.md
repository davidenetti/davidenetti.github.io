...
- **CVE-2026-21709**: In collaboration with Andrea Monzani and Antonio Parata, we discovered this vulnerability in a driver of Veeam's utility that allow an attacker to execute a buffer overflow ny abusing an incorrect use of the RtlQueryRegistryValues function, that in our PoC allow to disable the DSE.
